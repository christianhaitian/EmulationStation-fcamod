	...
	mClose(false)
{
	...
	mBox.setImagePath(theme->Background.path); // ":/frame.png"
	...
	mSystemName = std::make_shared<TextComponent>(mWindow, Utils::String::toUpper(mSearchParams.system->getFullName()), 
	...
	buttons.push_back(std::make_shared<ButtonComponent>(mWindow, _T("INPUT"), _T("search"), [&] {
