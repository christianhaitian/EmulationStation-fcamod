...
//	{ 1,  "sortname",    MD_STRING,              "",                 false,      "sortname",             "enter game sort name"},
	...
	{ 5,  "governor",    MD_PLIST,				 "",                 false,      "governor",			 "governor" },
	{ 6,  "image",       MD_PATH,                "",                 false,      "image",                "enter path to image"},
	{ 7,  "video",       MD_PATH     ,           "",                 false,      "video",                "enter path to video"},
	{ 8,  "marquee",     MD_PATH,                "",                 false,      "marquee",              "enter path to marquee"},
	{ 9,  "thumbnail",   MD_PATH,                "",                 false,      "thumbnail",            "enter path to thumbnail"},
	{ 10,  "rating",      MD_RATING,              "0.000000",         false,      "rating",               "enter rating"},
	{ 11, "releasedate", MD_DATE,                "not-a-date-time",  false,      "release date",         "enter release date"},
	{ 12, "developer",   MD_STRING,              "unknown",          false,      "developer",            "enter game developer"},
	{ 13, "publisher",   MD_STRING,              "unknown",          false,      "publisher",            "enter game publisher"},
	{ 14, "genre",       MD_STRING,              "unknown",          false,      "genre",                "enter game genre"},
	{ 15, "players",     MD_INT,                 "1",                false,      "players",              "enter number of players"},
	{ 16, "favorite",    MD_BOOL,                "false",            false,      "favorite",             "enter favorite off/on"},
	{ 17, "hidden",      MD_BOOL,                "false",            false,      "hidden",               "enter hidden off/on" },
